...
Input data is a random 1GB file, generated by `generate_matrix_market` as above, and the same file sorted (by row then column index) again by `sort_matrix_market` as above.
